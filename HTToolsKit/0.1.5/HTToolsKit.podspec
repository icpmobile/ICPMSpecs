...
#  s.source_files = 'HTToolsKit/Classes/**/*'
  ...
  s.subspec 'FontHelper' do |fh|
    fh.source_files = 'HTToolsKit/Classes/FontHelper'
  end
  ...
  s.subspec 'NormalTools' do |si|
    si.source_files = 'HTToolsKit/Classes/NormalTools'
  ...
  s.subspec 'FileDownloadOrUpload' do |si|
    ...
    si.dependency 'HTToolsKit/NormalTools'
    si.dependency 'HTToolsKit/OtherHelper'
    si.dependency 'MBProgressHUD'
  end
